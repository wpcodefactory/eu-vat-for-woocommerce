...
[https://github.com/wpcodefactory/eu-vat-for-woocommerce](https://github.com/wpcodefactory/eu-vat-for-woocommerce)
...
* Dev - Improved VAT meta box compatibility with legacy orders and HPOS.
...
= 4.8.0 - 18/08/2026 =
* Fix - Fixed "Remove VAT for validated numbers" validation.
* Fix - Fixed conditional required VAT field validation.
* Dev - Added a 10s connection timeout to the SOAP client (and `wpfactory_wc_eu_vat_soap_connection_timeout` filter).
* WC tested up to: 11.0.

= 4.7.9 - 03/08/2026 =
* Fix - Fixed VAT validation on WooCommerce signup and edit billing forms.
* Dev - WPFactory Admin Menu - Library updated (to v1.1.2).

= 4.7.8 - 29/07/2026 =
* Fix - Fixed validation for `0` VAT numbers during checkout.
* Fix - Improved VAT validation logic for country matching and VIES fallback.

= 4.7.7 - 26/07/2026 =
* Fix - Fixed validation for optional VAT numbers when left empty.
* Fix - Fixed a PHP warning during VAT validation.

= 4.7.6 - 24/07/2026 =
* Fix - Prevent checkout with invalid VAT number `0`.

= 4.7.5 - 23/07/2026 =
* Fix - Validation - Fixed `alg_wc_eu_vat_is_valid_vat_at_checkout` to use the final validation result.
* Dev - Advanced - Checkout block field - Default value set to `yes`.
* Dev - Allow checkout on unregistered VAT numbers - Data added to the log.
* Dev - Added `alg_wc_eu_vat_validation_message` filter for validation messages.
...
* Dev - Added a capability check before updating order VAT details in the admin.
...
* Dev - Removed PHP sessions and used WooCommerce sessions only.
...
* Dev - Validation - Advanced - VATSense.com API key - "Enable VATSense fallback" option added (defaults to "no").
...
* Dev - Improved VAT validation for checkout and related functions.
* Dev - Code refactoring and cleanup.

= 4.6.2 - 30/04/2026 =
* Dev - Block-based Checkout - Added "Let customer decide" feature.
* Dev - Block-based Checkout - Added "Confirmation notice" feature.
* Dev - Block-based Checkout - Added "Valid VAT but still paying" feature.
...
= 4.6.0 - 08/04/2026 =
* Fix - Block-based Checkout - Fixed VAT recalculation when the VAT number is removed.
* Fix - Block-based Checkout - Fixed VAT validation for manually pre-saved number.
* Fix - Block-based Checkout - Fixed VAT validation when postal code or state values change.
* Dev - General - Confirmation notice - "Add CSS selector(s) for extra payment buttons..." option added (defaults to empty).
* Deploy script updated.

= 4.5.9 - 27/03/2026 =
* Fix - Block-based Checkout - Resolved issue with "Keep VAT for this product".
* Dev - Improvement Block-based VAT validation.
* WC tested up to: 10.6.

= 4.5.8 - 24/02/2026 =
* Fix - Fixed initial show/hide behavior of the VAT field when the company name is checked.
* Fix - Corrected the "Country preserved" message.
* Fix - Block-based Checkout - Resolved VAT number field visibility issues.
* Fix - Block-based Checkout - Fixed VAT number required-field handling.
* Fix - Block-based Checkout - Corrected VAT number validation.
