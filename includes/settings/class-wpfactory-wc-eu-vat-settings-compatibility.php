...
if ( ! class_exists( 'WPFactory_WC_EU_VAT_Settings_Compatibility' ) ) :

class WPFactory_WC_EU_VAT_Settings_Compatibility extends WPFactory_WC_EU_VAT_Settings_Section {
...
return new WPFactory_WC_EU_VAT_Settings_Compatibility();
