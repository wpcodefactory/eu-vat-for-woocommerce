...
if ( ! class_exists( 'WPFactory_WC_EU_VAT_Settings_Section' ) ) :

class WPFactory_WC_EU_VAT_Settings_Section {
	...
	function __construct() {
		add_filter(
			'woocommerce_get_sections_' . 'wpfactory_wc_eu_vat',
			array( $this, 'settings_section' )
		);
		add_filter(
			'woocommerce_get_settings_' . 'wpfactory_wc_eu_vat' . '_' . $this->id,
