...
if ( ! class_exists( 'WPFactory_WC_EU_VAT_Settings_Progress' ) ) :

class WPFactory_WC_EU_VAT_Settings_Progress extends WPFactory_WC_EU_VAT_Settings_Section {
	...
	function get_settings() {
		return array(
			...
			array(
				...
				'desc_tip' => __( 'Message when validation is in progress. If you want to customize the message using CSS, please use class <code>wpfactory-wc-eu-vat-validating</code>', 'eu-vat-for-woocommerce' ),
			...
			array(
				...
				'desc_tip' => __( 'Message on valid VAT. If you want to customize the message using CSS, please use class <code>wpfactory-wc-eu-vat-valid</code>', 'eu-vat-for-woocommerce' ),
			...
			array(
				...
				'desc_tip' => __( 'Message on invalid VAT. If you want to customize the message using CSS, please use class <code>wpfactory-wc-eu-vat-not-valid</code>', 'eu-vat-for-woocommerce' ),
			...
			array(
				...
				'desc_tip' => __( 'Message on VAT validation server timeout etc. If you want to customize the message using CSS, please use class <code>wpfactory-wc-eu-vat-validation-failed</code>', 'eu-vat-for-woocommerce' ),
			...
			array(
				...
				'desc_tip' => (
					...
					__( 'If you want to customize the message using CSS, please use the <code>wpfactory-wc-eu-vat-not-valid-billing-country</code> class.', 'eu-vat-for-woocommerce' )
				),
			...
			array(
				...
				'desc_tip' => __( 'Message on Different shipping & billing countries. If you want to customize the message using CSS, please use class <code>wpfactory-wc-eu-vat-not-valid-billing-country</code>', 'eu-vat-for-woocommerce' ),
			...
			array(
				...
				'desc_tip' => sprintf(
					...
					'<code>wpfactory-wc-eu-vat-not-valid-base-country-shipping</code>'
				),
			...
			array(
				...
				'desc_tip' => __( 'Message on Company name mismatch. If you want to customize the message using CSS, please use class <code>wpfactory-wc-eu-vat-not-valid-company-mismatch</code>', 'eu-vat-for-woocommerce' ),
			...
			array(
				...
				'desc_tip' => __( 'Message on billing country preserved for VAT. If you want to customize the message using CSS, please use class <code>wpfactory-wc-eu-vat-not-valid-country-preserved</code>', 'eu-vat-for-woocommerce' ),
			...
			array(
				...
				'desc_tip' => __( 'Message on VIES error. If you want to customize the message using CSS, please use class <code>wpfactory-wc-eu-vat-not-valid-vies-error</code>', 'eu-vat-for-woocommerce' ),
...
return new WPFactory_WC_EU_VAT_Settings_Progress();
