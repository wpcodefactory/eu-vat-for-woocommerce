...
if ( ! class_exists( 'WPFactory_WC_EU_VAT_Settings' ) ) :

class WPFactory_WC_EU_VAT_Settings extends WC_Settings_Page {
	...
	function __construct() {
		...
		$this->id    = 'wpfactory_wc_eu_vat';
		$this->label = __( 'EU VAT', 'eu-vat-for-woocommerce' );
		parent::__construct();

		// Sections
		require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-eu-vat-settings-section.php';
		require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-eu-vat-settings-general.php';
		require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-eu-vat-settings-validation.php';
		require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-eu-vat-settings-progress.php';
		require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-eu-vat-settings-admin.php';
		require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-eu-vat-settings-advanced.php';
		require_once plugin_dir_path( __FILE__ ) . 'class-wpfactory-wc-eu-vat-settings-compatibility.php';
...
return new WPFactory_WC_EU_VAT_Settings();
