...
if ( ! class_exists( 'WPFactory_WC_EU_VAT_Admin_Exempt' ) ) :

class WPFactory_WC_EU_VAT_Admin_Exempt {
	...
	function ajax( $param ) {
		...
		if (
			...
			! wp_verify_nonce(
				...
				'wpfacotry-wc-eu-vat-ajax-nonce'
			)
		) {
...
return new WPFactory_WC_EU_VAT_Admin_Exempt();
